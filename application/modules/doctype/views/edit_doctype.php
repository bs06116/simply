...
<div class="content-wrapper">
    ...
    <div class="content p-t-0">
        ...
        <section class="content m_b_20 white_bg box">
            <form  id="validation_form" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?><?php echo $this->config->item('doctype_path'); ?>update_doctype">
                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" id="name" value="<?php echo $single_data->name;?>" placeholder="Document Type"
                                               class="form-control" >

                                        <div class="help-block form-error"><?php echo form_error('name'); ?></div>
                                        <div class="help-block form-error"><?php echo form_error('update_doctype_exist'); ?></div>
...
<input type="hidden" value="<?php echo $single_data->id;?>" name="doctype_id" />

                    <div class="col-lg-12">
                        <button type="submit"  value="Save" id="submit_document" class="btn btn-info mybtn_primary"> Update</button>
