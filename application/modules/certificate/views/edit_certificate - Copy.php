          ...
          <div class="col-lg-12">
          	<div class="row m_b_20 certificate_header">
                ...
                <div class="col-lg-4 text-right">
                	<h2>CERTIFICATE No : <?php echo $certificate->cert_code;?></h2>
                    <p>Date : <?php echo date("d-m-Y", strtotime($certificate->cer_date));?></p>
                    <p>Customer No : 772016</p>
                </div>
            </div>
            ...
            <div class="row m_b_20">
            	 <div class="col-lg-3">
                	<div class="form-group">
                        ...
                        <input type="text" name="c_name" id="c_name" placeholder="Search by name"  value="<?php echo $certificate->c_name;?>" class="form-control" >
                    </div>
                </div>
                <div class="col-lg-3">
                	<div class="form-group">
                ...
                <div class="col-lg-3">
                	<div class="form-group">
                        ...
                        <input type="text" name="p_no" id="p_no" placeholder="Search by Identification No" value="<?php echo $certificate->p_no;?>" class="form-control" >
                    </div>
                </div>
                <div class="col-lg-3">
                	<div class="form-group">
                    	<label>Sales Person</label>
                 <input type="text"  name="sale_person" value="<?php echo $certificate->sale_person;?>" class="form-control" >
                    </div>
                </div>
                <div class="col-lg-3">
                	<div class="form-group">
            ...
            <input type="button"  id="submit_certificate" value="Update"/>
            </form>
            <div class="row m_b_20">
            	<div class="col-lg-12">
            	...
            	<div class="col-lg-12">
                	<table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td><span id="qun"><?php echo $certificate->e_doc_no;?></span></td>
                            <td><?php echo date("d-m-Y", strtotime($certificate->cer_date));?></td>
                            <td><span id="tfactor"><?php echo $certificate->factor;?></span></td>
                            <td><span id="swl"><?php echo $certificate->swl;?></span></td>
                            <td><span id="wll"><?php echo $certificate->wll;?></span></td>
                            <td><span id="mbl"><?php echo $certificate->mbl;?></span></td>
                        </tr>
