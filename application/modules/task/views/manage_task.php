                ...
                <div class="apend_sel_task">
                  <table id="data_table" class="table table-bordered table-striped icon_space all_tasks">
                    ...
                    <tbody>
                      ...
                      <? $k=1; if($total!=0){for($i=0;$i<$total;$i++) {
                      ...
                      <td><?php echo $k;?></td>
                        ...
                        <td>
					<?php if($all_task_project[$i]['task_piority']=='p1'){echo "<span title='critical' class='block'><span class='critical sm3'>P1</span><!--<span class='sm2'><i class='fa fa-circle' aria-hidden='true'></i> 
Critical&nbsp;&nbsp;</span>--></span>";} ?>
                     	<?php if($all_task_project[$i]['task_piority']=='p2'){echo "<span title='High' class='block'><span class='high sm3'>P2</span><!--<span class='sm2'><i class='fa fa-circle' aria-hidden='true'></i> High&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>--></span>";} ?>
                     	<?php if($all_task_project[$i]['task_piority']=='p3'){echo "<span title='Medium' class='block'><span class='medium sm3'>P3</span><!--<span class='sm2'><i class='fa fa-circle' aria-hidden='true'></i> Medium</span>--></span>";} ?>
                     	<?php if($all_task_project[$i]['task_piority']=='p4'){echo "<span title='Low' class='block'><span class='low sm3'>P4</span><!--<span class='sm2'><i class='fa fa-circle' aria-hidden='true'></i> Low&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>--></span>";} ?></td>
                        <td><?=$all_task_project[$i]['project_name'];?></td>
                        <td><?php  echo implode(" ",$get_task_arrachment);?></td>
                        <!--<td><?=$all_task_project[$i]['description'];?></td>-->
                       
                        <td><a data-toggle="modal" data-target="#get_task_data" onclick="get_single_task('<?=$all_task_project[$i]['task_id'];?>')" class="btn btn-primary btn-icon btn-iconlast view" title="View"><i class="fa fa-eye" aria-hidden="true"></i></a> <a class="btn btn-primary btn-icon" data-toggle="modal" data-target="#update_project_modal"   href="#" onclick="get_task('<?php echo $all_task_project[$i]['task_id']?>')" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a><a  class="btn btn-danger btn-icon" onclick="return confirm('Are you sure want to delete this record.')" href="<?=base_url();?><?php echo $this->config->item('task_path'); ?>delete_task/<?=$all_task_project[$i]['task_id'];?>" title="Delete"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
           ...
           <div class="form-group">
        		...
        		<div class="row">
        		  <div class="col-lg-12">
                    ...
                    <label for="section">Description</label>
                            <textarea type="text"  name="description" id="description2" class="description" class="form-control"></textarea>
                   	</div>
                  </div>
                </div>
                <div class="row">
