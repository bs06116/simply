                                                ...
                                                <div class="row">
                                                  <div class="col-lg-6">
                                                    <div class="form-group">
                                                      <label>Name *</label>
                                                      <input required="required" type="text" class="form-control" value="<?php echo $user_data->person?>" id="person" name="person" />
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                          <div class="col-lg-6">
                            <div class="form-group">
                              <label>Name</label>
                              <input type="text" class="form-control" value="<?php echo $ui['name']?>" name="name[]" />
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group">
                              <label>Phone</label>
                              <input type="text" class="form-control" value="<?php echo $ui['phone']?>" name="phone_2[]" />
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-lg-6">
                            <div class="form-group">
                              <label>Email</label>
                              <input type="text" class="form-control" value="<?php echo $ui['email']?>" name="email_2[]" />
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group">
                              <label>Designation</label>
                              <input type="text" class="form-control" value="<?php echo $ui['designation']?>" name="designation[]" />
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="row">
                          <div class="col-lg-6">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="address_one" value="<?php echo $ua['street_one']?>"  name="address_one[]" />
                            </div>
                            <div class="form-group">
                              <label>Street 2</label>
                              <input type="text" class="form-control" id="address_two" value="<?php echo $ua['street_two']?>" name="address_two[]" />
                            </div>
                            <div class="form-group">
                              <label>Country</label>
                              <select name="country[]" class="select_2 form-control" value="<?php echo $ua['country']?>" style="width:100%;">
                          ...
                          <div class="col-lg-6">
                          	<div class="form-group">
                              <label>City</label>
                              <input type="text" class="form-control" id="city" value="<?php echo $ua['city']?>" name="city[]" />
                            </div>
                            <div class="form-group">
                              <label>Post Code</label>
                              <input type="text" class="form-control" id="postal_code" value="<?php echo $ua['postal_code']?>" name="postal_code[]" />
                            </div>
                          </div>
                        </div>
