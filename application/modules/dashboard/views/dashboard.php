                        ...
                        <div class="col-lg-12 col-lg-12up">
                            <div class="col-lg-8 tasks rem_padd">
                                <div class="box-header">
                                    ...
                                    <!-- first-task-->
                                    <button class="collapse1 btn btn-primary mybtn_primary">My Tasks</button>
                                    <button class="collapse2 btn btn-primary mybtn_primary">All Tasks</button>
                                    <a data-toggle="modal" data-target="#import_data"
                                       class="btn btn-primary mybtn_primary"><i class="fa fa-fw fa-plus"></i> </a>
                                    <!-- pop up -->
                                    <div id="import_data" class="modal fade modalfadeup" role="dialog"
                                         style="width: 720px; padding-left:0;">
                                                ...
                                                <div class="modal-content">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select id="project_id" name="project_id"
                                                                                ...
                                                                                style="width:100%">
                                                                            <option value="0">Please select Project
                                                                            </option>
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-group form-control"
                                                                            ...
                                                                            <option value="3">On Hold or Not started
                                                                            </option>
                                                                ...
                                                                <div class="form-group col-lg-6">
                                                                    <div class="checks">
                                                                        ...
                                                                        <select class="form-group selectpicker" multiple
                                                                                name="user[]" id="test">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div id="error_msg" style=" display:none;"
                                                             class="alert custom-error alert-danger"></div>
                                                        <div id="success_msg" style=" display:none;"
                                                             class="alert custom-error alert-success"></div>
                                                    </div>
                                                    <div class="modal-footer"><a href="#" id="submit_type2"
                                                                                 class="btn btn-primary mybtn_primary">Save</a>
                                                        <button type="button" class="btn btn-default mybtn_primary"
                                        ...
                                        <table>
                                            ...
                                            <?php foreach ($all_user_task as $aut): ?>
                                                <tr style="cursor:pointer;">
                                                    <td data-toggle="modal" data-target="#tskstatus"
                                                        onClick="get_task_status('<?php echo $aut->task_id; ?>','<?php echo $aut->task_status; ?>')">

                                                        <?php if ($aut->task_status == 1) {
                                                            echo "<i class='fa fa-circle complete' aria-hidden='true' title='Complete'></i>";
                                                        } ?>
                                                        <?php if ($aut->task_status == 2) {
                                                            echo "<i class='fa fa-circle inprogress' aria-hidden='true' title='In Progress'></i>";
                                                        } ?>
                                                        <?php if ($aut->task_status == 3) {
                                                            echo "<i class='fa fa-circle onhold' aria-hidden='true' title='On Hold or not Started'></i>";
                                                        } ?>
                                                    </td>
                                                    <td onClick="get_single_task('<?php echo $aut->task_id; ?>')"
                                                        data-toggle="modal"
                                                        data-target="#get_task_data"><?php echo $aut->name; ?></td>
                                                    <td onClick="get_single_task('<?php echo $aut->task_id; ?>')"
                                                        data-toggle="modal"
                                                        data-target="#get_task_data"><?php echo $aut->deadline; ?></td>
                                                    <td onClick="get_single_task('<?php echo $aut->task_id; ?>')"
                                                        data-toggle="modal"
                                                        data-target="#get_task_data"><?php echo $aut->fullname; ?></td>
                                                    <td data-toggle="modal" data-target="#tskpriority"
                                                        onClick="get_task_pri('<?php echo $aut->task_id; ?>','<?php echo $aut->task_piority; ?>')">

                                                        <?php if ($aut->task_piority == 'p1') {
...
Critical&nbsp;&nbsp;</span>--></span>";
                                                    ...
                                                    <td onClick="get_single_task('<?php echo $aut->task_id; ?>')"
                                                        data-toggle="modal"
                                                        data-target="#get_task_data"><?php echo $aut->project_name; ?></td>
                                                </tr>
                                            <?php endforeach; ?>
                                            </tr>
                                        ...
                                        <table>
                                            ...
                                            <?php foreach ($all_task as $at):
                                                ...
                                                <tr style="cursor:pointer;">
                                                    ...
                                                    <td data-toggle="modal" data-target="#tskstatus"
                                                        onClick="get_task_status('<?php echo $aut->task_id; ?>','<?php echo $aut->task_status; ?>')"><?php if ($at->task_status == 1) {
                                                            echo "<i class='fa fa-circle complete' aria-hidden='true' title='Complete'></i>";
                                                        } ?>
                                                        <?php if ($at->task_status == 2) {
                                                            echo "<i class='fa fa-circle inprogress' aria-hidden='true' title='In Progress'></i>";
                                                        } ?>
                                                        <?php if ($at->task_status == 3) {
                                                            echo "<i class='fa fa-circle onhold' aria-hidden='true' title='On Hold or not Started'></i>";
                                                        } ?>
                                                    </td>

                                                    <td onClick="get_single_task('<?php echo $at->task_id; ?>')"
                                                        data-toggle="modal"
                                                        data-target="#get_task_data"><?php echo $at->name; ?></td>
                                                    <td onClick="get_single_task('<?php echo $at->task_id; ?>')"
                                                        data-toggle="modal"
                                                        data-target="#get_task_data"><?php echo $at->deadline; ?></td>
                                                    <td onClick="get_single_task('<?php echo $at->task_id; ?>')"
                                                        data-toggle="modal"
                                                        data-target="#get_task_data"><?php echo implode(",", $data_array); ?></td>
                                                    <td data-toggle="modal" data-target="#tskpriority"
                                                        onClick="get_task_pri('<?php echo $at->task_id; ?>','<?php echo $at->task_piority; ?>')"><?php if ($at->task_piority == 'p1') {
                                                            echo "<span title='Critical' class='block'><span class='critical sm3'>P1</span><!--<span class='sm2'><i class='fa fa-circle' aria-hidden='true'></i> 
Critical&nbsp;&nbsp;</span>--></span>";
                                                        } ?>
                                                        <?php if ($at->task_piority == 'p2') {
                                                            echo "<span title='High' class='block'><span class='high sm3'>P2</span><!--<span class='sm2'><i class='fa fa-circle' aria-hidden='true'></i> High&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>--></span>";
                                                        } ?>
                                                        <?php if ($at->task_piority == 'p3') {
                                                            echo "<span title='Medium' class='block'><span class='medium sm3'>P3</span><!--<span class='sm2'><i class='fa fa-circle' aria-hidden='true'></i> Medium</span>--></span>";
                                                        } ?>
                                                        <?php if ($at->task_piority == 'p4') {
                                                            echo "<span title='Low' class='block'><span class='low sm3'>P4</span><!--<span class='sm2'><i class='fa fa-circle' aria-hidden='true'></i> Low&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>--></span>";
                                                        } ?>
                                                    </td>
                                                    <td onClick="get_single_task('<?php echo $at->task_id; ?>')"
                                                        data-toggle="modal"
                                                        data-target="#get_task_data"><?php echo $at->project_name; ?></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </table>
                                    </div>
                            ...
                            <div class="col-lg-4 dash-new rem_padd">
                                <div class="col-lg-12 title">
                                    ...
                                    <a href="#" style="margin-top:10px;  float: right;" class="cus-btn"
                                       data-toggle="modal" data-target="#add_customer_feed">
             ...
             <?php endforeach;?><?php */ //print_r($all_newfeed);?>
                                    ...
                                    foreach ($get_all_cuts as $an) {
                                        ...
                                        if (!empty($get_latest_news)) {
                                            ...
                                            <div class="das-feed">
                                                <a href="#"
                                                   onclick="get_feed_note('<?php echo $get_latest_news->customer_id; ?>')"
                                                   class="" data-toggle="modal" data-target="#view_feed_customer">


                                                    <h4 class="hchange"
                                                        style="margin-bottom:2px; color:#D33724;"><?php echo $get_latest_news->name; ?></h4>
                                                </a>
                                                ...
                                                <?php }else{
                                                echo $get_latest_news->message; ?></p>
                    ...
                    <div class="row rowfooter">
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-aqua">
                                ...
                                <a href="<?php echo base_url() ?>user/manage_user" class="small-box-footer">More info <i
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-green">
                                ...
                                <a href="<?php echo base_url(); ?>product/manage_product" class="small-box-footer">More
                                    info <i class="fa fa-arrow-circle-right"></i></a></div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-3 col-xs-6">
                            <!-- small box -->
                            <div class="small-box bg-red">
                                ...
                                <a href="<?php echo base_url(); ?>certificate/manage_certificate"
                                   class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a></div>
                        </div>
                        <div class="col-lg-3 col-xs-6">
                            <!-- small box -->
                            <div class="small-box bg-yellow">
                                ...
                                <div class="icon"><i class="fa fa-files-o"></i></div>
                                <a href="<?php echo base_url(); ?>project/manage_project" class="small-box-footer">More
                                    info <i class="fa fa-arrow-circle-right"></i></a></div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <label for="section">Description</label>
                                <textarea type="text" name="description" id="description2"
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (obj.status == 0) {
                    ...
                    setTimeout(function () {
                        window.location.replace("<?php echo base_url()?><?php echo $this->config->item('dashboard_path'); ?>");
                    }, 2000);
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="c_name" id="c_name" placeholder="Search by name"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label>Message</label>
                                            <textarea type="text" name="message_n" class="form-control"
...
<script>
    $('.drpoption').change(function() {
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo base_url()?><?php echo $this->config->item('document_path'); ?>' + "filter_document/"+document_type_id+"/"+0,
            success: function (response) {
